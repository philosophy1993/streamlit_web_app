...
def app2():
    ...
    with st.form(key = 'profile_form'):
        #AIへの前提をインプット
        AI_input = st.text_area('前提のインプット', value="""#あなたは動物の研究者です。\n#'user'で入力される動物の豆知識について、冗談を交えながら、二人の成人女性が会話しているように解説してください。\n#解説は500文字程度で、以下の特性以外にも知っていることがあったら補足してください。\n#二人の成人女性の会話以外の解説はいりません。
        \n#会話の出力は表形式でお願いします。(列に発言者、隣に発言内容)""")
